...
// Interface para outputs padronizados
export interface OutputItem {
  type: 'text' | 'json' | 'table' | 'chart' | 'code' | 'error' | 'warning' | 'info';
  content: any;
  timestamp: string;
  title?: string;
...
// Interface para mensagem de stream com outputs
